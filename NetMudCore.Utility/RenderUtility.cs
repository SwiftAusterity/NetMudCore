...
namespace NetMudCore.Utility
{
    ...
    public static partial class RenderUtility
    {
        ...
        public static string CapsFirstLetter(this string value, bool onlyFirstLetter = false)
        {
            ...
            string firstLetter = value[..1].ToUpperInvariant();
            string wordRemainder = onlyFirstLetter ? value[1..] : value[1..].ToLowerInvariant();
        ...
        public static string CommaList(this string[] stringList, SplitListType mode)
        {
            ...
            switch (mode)
            {
                ...
                case SplitListType.CommaWithAnd:
                    ...
                    returnString = string.Format("{0} and {1}", returnString[..lastComma], returnString[(lastComma + 1)..]);
                    break;
                case SplitListType.OxfordComma:
                    ...
                    {
                        returnString = string.Format("{0} and {1}", returnString[..lastOxfordComma], returnString[(lastOxfordComma + 1)..]);
                    }
                    else
                    {
                        returnString = string.Format("{0}, and {1}", returnString[..lastOxfordComma], returnString[(lastOxfordComma + 1)..]);
