    ...
    public static partial class DataUtility
    {
        ...
        public static bool IsNumeric<T>(this string str)
        {
            ...
            if (!string.IsNullOrWhiteSpace(str))
            {
                ...
                {
                    return ulong.TryParse(str, out _);
                }
        ...
        public partial class EntityFileData
        {
            ...
            public string XmlString
            {
                get
                {
                    ...
                    xml = RemoveNonAscii().Replace(xml, string.Empty); // Removes non ascii characters
                    return xml;
                }
                set
                {
                    value = RemoveNonAscii().Replace(value, string.Empty); // Removes non ascii characters
            ...
            [GeneratedRegex("[^\\u0000-\\u007F]")]
            private static partial Regex RemoveNonAscii();
        }
        #endregion
