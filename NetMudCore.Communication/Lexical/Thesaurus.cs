    ...
    public static class Thesaurus
    {
        public static string GetTranslatedWord(string azureKey, string phrase, ILanguage sourceLanguage, ILanguage targetLanguage)
        {
            ...
            try
            {
                ...
                dynamic result = JsonSerializer.SerializeToDocument(jsonResponse);
        ...
        {
            if (word == null || !possibleWords.Any() || obscureStrength == 0)
            {
                return word;
            }
            ...
            if (newWord != null)
            {
                ...
                {
                    LexicalContext itContext = new(null, null, word.Language)
                    {
                        Determinant = false,
                        Plural = false,
                        Possessive = false,
