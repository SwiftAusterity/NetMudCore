...
using NetMudCore.Lexica.DeepLex;
...
namespace NetMudCore.Communication.Lexical
{
    ...
    /// </summary>
    public static partial class LexicalProcessor
    {
        ...
        public static ILexeme CreateOrModifyLexeme(ILanguage language, string word, LexicalType wordType, ref List<string> processedWords)
        {
            ...
            newLex ??= language.CreateOrModifyLexeme(word, wordType, Array.Empty<string>());
                ...
                if (!invalidTypes.Contains(wordType))
                {
                    ...
                    if (synSets != null)
                    {
                        ...
                        foreach (SynSet synSet in synSets)
                        {
                            ...
                            if (newDict == null)
                            {
                                newLex = language.CreateOrModifyLexeme(word, MapLexicalTypes(synSet.PartOfSpeech), Array.Empty<string>());
        ...
        public static ILexeme VerifyLexeme(ILexeme lexeme)
        {
            ...
            if (lexeme.Language == null)
            {
                ...
                _ = globalConfig?.DeepLexActive ?? false;
            }
        ...
        public static LexicalType MapLexicalTypes(PartOfSpeech pos)
        {
            return pos switch
            {
                PartOfSpeech.Adjective => LexicalType.Adjective,
                PartOfSpeech.Adverb => LexicalType.Adverb,
        ...
        public static PartOfSpeech MapLexicalTypes(LexicalType pos)
        {
            return pos switch
            {
                LexicalType.Adjective => PartOfSpeech.Adjective,
                LexicalType.Adverb => PartOfSpeech.Adverb,
                LexicalType.Noun => PartOfSpeech.Noun,
                LexicalType.Verb => PartOfSpeech.Verb,
                _ => PartOfSpeech.None,
            };
        }
        ...
        public static LexicalType MapLexicalTypes(string fl)
        {
            return fl switch
            {
                "adjective" => LexicalType.Adjective,
                "adverb" => LexicalType.Adverb,
                "noun" => LexicalType.Noun,
                "verb" => LexicalType.Verb,
                _ => LexicalType.None,
            };
        }
