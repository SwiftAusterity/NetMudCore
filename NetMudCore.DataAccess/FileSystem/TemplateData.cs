...
namespace NetMudCore.DataAccess.FileSystem
{
    public class TemplateData : FileAccessor
    {
        ...
        public override string BaseDirectory
        {
            get
            {
                return null;// HostingEnvironment.MapPath(base.BaseDirectory + "Templates/");
            }
        }
        ...
        public static IKeyedData ReadEntity(FileInfo file, Type entityType)
        {
        ...
        public void ArchiveFull(string backupName = "")
        {
            ...
            if (VerifyDirectory(BaseDirectory + CurrentDirectoryName, false) && VerifyDirectory(BaseDirectory + ArchiveDirectoryName))
            {
                ...
                string backupDir = BaseDirectory + DatedBackupDirectory;
        ...
        private static string GetEntityFilename(IKeyedData entity)
        {
