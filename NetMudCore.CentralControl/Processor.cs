...
namespace NetMudCore.CentralControl
{
    ...
    {
        private static readonly ObjectCache globalCache = System.Runtime.Caching.MemoryCache.Default;
        ...
        private static IList<Tuple<Func<bool>, int>> SubscribeToLoop(string designator, Func<bool> subscriber, int pulseCount)
        {
            ...
            if (globalCache.Get(taskKey) is not IList<Tuple<Func<bool>, int>> taskList)
            {
        ...
        private static IList<Tuple<Func<bool>, int>> GetLoopSubscribers(string designator)
        {
            ...
            try
            {
                if (globalCache.Get(taskKey) is not IList<Tuple<Func<bool>, int>> subscriberList)
                {
