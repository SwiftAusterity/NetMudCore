...
namespace NetMudCore.DataAccess.Cache
{
    /// <summary>
    /// A cache key for live entities
    /// </summary>
    [Serializable]
    public class TemplateCacheKey : ICacheKey
    {
        [JsonIgnore]

        public CacheType CacheType
        {
            get { return CacheType.Template; }
        }
        ...
        [JsonConstructor]
        public TemplateCacheKey(Type objectType, long birthMark)
        {
        ...
        public TemplateCacheKey(IKeyedData data)
        {
