...
namespace NetMudCore.DataAccess.FileSystem
{
    public abstract class FileAccessor
    {
        ...
        public static bool WriteToFile(string fullFileName, byte[] bytes, FileMode writeMode = FileMode.Truncate)
        {
        ...
        internal static void CullDirectoryCount(string baseDirectoryPath)
        {
            try
            {
