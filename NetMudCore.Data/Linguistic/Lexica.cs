...
namespace NetMudCore.Data.Linguistic
{
    ...
    public class Lexica : ILexica
    {
        ...
        public Lexica()
        {
            ...
            Context = new LexicalContext(null, null, null);
        }
        ...
        private static LexicalContext BuildContext(IEntity entity, IEntity observer)
        {
        ...
        private static ILexica RunObscura(MessagingType sensoryType, IEntity observer, bool over)
        {
        ...
        public IEnumerable<ILexica> Unpack(MessagingType sensoryType, short strength)
        {
